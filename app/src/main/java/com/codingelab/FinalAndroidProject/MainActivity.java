...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Intent sqlLiteIntent = new Intent(this, CLocalDb.class);
        ...
        btnser = (Button) findViewById(R.id.ser);
        final Intent i = new Intent(this, PhpSearchActivity.class);
    ...
    private void TruncateServerTable() {
        ...
        class GetJSON extends AsyncTask<Void, Void, String> {
            ...
            protected String doInBackground(Void... voids) {
                try {
                    URL url = new URL("http://192.168.43.67:80/sqli/mysql_truncate.php");
    ...
    private void SyncData()
    {
        ...
        for(int i = 0 ; i < adapter.getCount();i++) {
            managePhp.doInBackground("managePhp",mydb.getAllContactsIDs().get(i),mydb.getAllContactsNames().get(i),mydb.getAllContactsPhones().get(i),mydb.getAllContactsEmails().get(i));
