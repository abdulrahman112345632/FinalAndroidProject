...
import com.codingelab.FinalAndroidProject.R;

import java.util.ArrayList;

public class listViewAdapter {
    public ArrayList<LocalData> personlist;
    Activity activity;
    //SearchActivity s;

    public listViewAdapter(Activity activity, ArrayList<LocalData> personlist) {
        super();
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        LocalData item = personlist.get(position);
